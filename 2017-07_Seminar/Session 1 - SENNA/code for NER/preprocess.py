"""
The file preprocesses the data/NER-de-train.tsv, data/NER-de-dev.tsv and data/NER-de-test.tsv from the GermEval 2014 shared task on German NER

It requires pre-trained word embeddings for German. It tries to download those from 
