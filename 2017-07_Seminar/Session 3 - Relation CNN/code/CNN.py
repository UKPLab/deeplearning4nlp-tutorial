...
words = Embedding(embeddings.shape[0], embeddings.shape[1], input_length=max_sentence_len, weights=[embeddings], trainable=False)(words_input)

distance1_input = Input(shape=(max_sentence_len,), dtype='int32', name='distance1_input')
distance1 = Embedding(max_position, position_dims, input_length=max_sentence_len)(distance1_input)

distance2_input = Input(shape=(max_sentence_len,), dtype='int32', name='distance2_input')
distance2 = Embedding(max_position, position_dims, input_length=max_sentence_len)(distance2_input)
